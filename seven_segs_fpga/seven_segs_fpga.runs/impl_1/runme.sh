...
HD_PWD='D:/NIE_training_program/day7/seven_segs_fpga/seven_segs_fpga.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log seven_segment_switches.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source seven_segment_switches.tcl -notrace
