...
HD_PWD='D:/NIE_training_program/day7/seven_segs_fpga/seven_segs_fpga.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log seven_segment_switches.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source seven_segment_switches.tcl
